...
const path = require("path"); // ✅ Importamos para rutas de archivos
...
// ✅ Servir archivos ESTÁTICOS DESDE LA CARPETA RAÍZ (no public)
...
// ===============================
// RUTAS PÁGINAS (sin carpeta public) ✅
// ===============================
// Página principal
app.get("/", (req, res) => {
...
// Ruta para panel admin (si tienes admin.html)
...
// ===============================
app.listen(PORT, () => {
console.log(`Servidor corriendo en puerto ${PORT} → sin carpeta public`);
});
